...
const Header = (props) => {
  ...
  const joinClass = () => {
    ...
    if (code.length === 5) {
      dispatch(userActions.joinSubject(data))
        .then(() => {
  ...
  const createSubject = () => {
    ...
    if (user.isAdmin) {
      if (newSubject.length > 6) {
        ...
        dispatch(facultyActions.createSubject(data))
          .then(() => {
        ...
        setCreateInProgress(false);
        props.openSnackBar(
          "Subject name should consists a minimum of 6 characters"
        );
        setOpenCreateDialog(false);
      }
    }
  ...
  return (
    <>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Enter Classroom Code provided by the Faculty
          </DialogContentText>
          <TextField
            autoFocus
            margin="dense"
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Enter the Name of the Subject you want to create
          </DialogContentText>
          <TextField
            autoFocus
            margin="dense"
